...
android {
    ...
    // Load CI signing config if signing.properties exists (generated by workflow)
    val signingProps = file("signing.properties").takeIf { it.exists() }?.let { f ->
    ...
    buildTypes {
        debug {
            ...
            // Apply CI signing key when signing.properties exists
            if (signingProps != null) {
